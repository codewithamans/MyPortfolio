          ...
          <div className="grid lg:grid-cols-2 gap-8 m-4">
            {data.map((data, index) => {
              return (
                <div
                  key={index}
                  className=" rounded-xl lg:hover:scale-105  ease-in-out duration-100 items-center justify-center h-auto w-full shadow-xl shadow-gray-300 bg-gradient-to-r from-[#ffafbd] to-[#ffc3a0]"
                >
